...
while query != 'q':
    ...
    # print("results_took:", results["took"])
    # print("results_time_out:", results["timed_out"])
    # print("results__shards:", results["_shards"])
    # print("results_hits/total", results["hits"]["total"])
    # print("results_hits/max_score", results["hits"]["max_score"])
    # print("results_hits/hits/1", results["hits"]["hits"][1])
